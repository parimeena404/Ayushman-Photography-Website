...
const PRODUCTS_DB: Record<string, ProductSpec> = {
  'visiting-card': {
    ...
    defaultImage: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&q=80',
  ...
  'wedding-card': {
    ...
    defaultImage: 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=600&q=80',
