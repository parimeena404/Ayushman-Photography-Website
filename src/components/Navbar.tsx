    ...
    columns: [
      {
        ...
        items: [
          { label: 'Letterheads', href: '/products?category=Business Cards' },
          { label: 'Custom Letterhead Pads', href: '/products?category=Business Cards' },
          { label: 'Bill Books', href: '/products?category=Business Cards' },
          { label: 'Envelopes', href: '/products?category=Business Cards' },
          { label: 'Custom Mouse Pads', href: '/products?category=Business Cards' },
          { label: 'Envelope Seals', href: '/products?category=Business Cards' },
          { label: 'Custom Pen Drive', href: '/products?category=Business Cards' },
          { label: 'Laptop Skins', href: '/products?category=Business Cards' },
          { label: 'Bulk Letterheads', href: '/products?category=Business Cards' },
          { label: 'Custom Pens', href: '/products?category=Business Cards' },
        ],
      },
      {
        heading: 'Office Supplies',
        items: [
          { label: 'Lanyards', href: '/products?category=Business Cards' },
          { label: 'ID Cards', href: '/products?category=Business Cards' },
          { label: 'Invoice Books', href: '/products?category=Business Cards' },
          { label: 'Note Cards', href: '/products?category=Business Cards' },
          { label: 'Custom Certificates', href: '/products?category=Business Cards' },
          { label: 'Awards', href: '/products?category=Business Cards' },
          { label: 'Coasters', href: '/products?category=Business Cards' },
          { label: 'Employee Welcome Kit', href: '/products?category=Business Cards' },
          { label: 'Cash Vouchers', href: '/products?category=Business Cards' },
          { label: 'Paper Identity Cards', href: '/products?category=Business Cards' },
        ],
      },
      {
        heading: 'Custom Notebooks & Diaries',
        items: [
          { label: 'Personalised Notebooks', href: '/products?category=Business Cards' },
          { label: 'Diary with Pen Holder', href: '/products?category=Business Cards' },
          { label: 'Personalised A5 Diary', href: '/products?category=Business Cards' },
          { label: 'Personalised Diary with Magnetic Lock', href: '/products?category=Business Cards' },
          { label: 'Notebook A4 Size', href: '/products?category=Business Cards' },
        ],
      },
      {
        ...
        items: [
          { label: 'Wedding Invitations', href: '/products?category=Wedding Cards' },
          { label: 'Save The Date Cards', href: '/products?category=Wedding Cards' },
          { label: 'Wedding Menu', href: '/products?category=Wedding Cards' },
          { label: 'Wedding Programmes', href: '/products?category=Wedding Cards' },
          { label: 'Shop all Wedding Stationery', href: '/products?category=Wedding Cards' },
        ],
      },
      {
        ...
        items: [
          { label: 'Thank You Cards', href: '/products?category=Business Cards' },
          { label: 'Birthday Invitations', href: '/products?category=Wedding Cards' },
          { label: 'Party invitations', href: '/products?category=Wedding Cards' },
          { label: 'Moving Announcements', href: '/products?category=Business Cards' },
          { label: 'Gift Tags', href: '/products?category=Business Cards' },
          { label: 'Shop all Invitations and Announcements', href: '/products?category=Wedding Cards' },
        ],
      },
      {
        heading: 'Explore More.',
        items: [
          { label: 'Gift Wrapping Paper', href: '/products?category=Flex Banners' },
          { label: 'Custom Paper Wrist Bands', href: '/products?category=Flex Banners' },
          { label: 'USB Flash Drive', href: '/products?category=Business Cards' },
          { label: 'Perfect Binding Booklets', href: '/products?category=Business Cards' },
          { label: 'Customised Mementos', href: '/products?category=Business Cards', isNew: true },
          { label: 'Recognition Plaques', href: '/products?category=Business Cards', isNew: true },
          { label: 'Star Performer Awards', href: '/products?category=Business Cards', isNew: true },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        ...
        items: [
          { label: 'Star Flex Outdoor Banners (₹18/sqft)', href: '/products?category=Flex Banners' },
          ...
          { label: 'Glow Sign Boards', href: '/products?category=Flex Banners' },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Corporate Postcards', href: '/products?category=Business Cards' },
          { label: 'Restaurant Menu Cards', href: '/products?category=Business Cards' },
          { label: 'Product Catalogs', href: '/products?category=Business Cards' },
    ...
    columns: [
      {
        ...
        items: [
          { label: 'Custom Die-Cut Stickers', href: '/products?category=Flex Banners' },
          { label: 'Product Packaging Labels', href: '/products?category=Flex Banners' },
          { label: 'Roll Labels', href: '/products?category=Flex Banners' },
          { label: 'Sheet Stickers', href: '/products?category=Flex Banners' },
          { label: 'Transparent Waterproof Stickers', href: '/products?category=Flex Banners', isNew: true },
        ],
      },
      {
        heading: 'Packaging Solutions',
        items: [
          { label: 'Printed Envelopes', href: '/products?category=Business Cards' },
          { label: 'Custom Shipping Boxes', href: '/products?category=Flex Banners' },
          { label: 'Branded Carry Bags', href: '/products?category=Flex Banners' },
          { label: 'Custom Gift Wrapping Paper', href: '/products?category=Flex Banners' },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        ...
        items: [
          { label: 'Custom Ceramic Photo Mugs', href: '/products?category=Custom Gifts' },
          { label: 'Magic Color Changing Photo Mugs', href: '/products?category=Custom Gifts' },
          { label: 'HD Photobooks & Wedding Albums', href: '/products?category=Photobooks' },
          { label: 'Custom Printed Keychains', href: '/products?category=Business Cards' },
          { label: 'Custom Magic Photo Cushions', href: '/products?category=Custom Gifts', isNew: true },
          { label: 'Custom Printed Polo T-shirts', href: '/products?category=Custom Gifts' },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        ...
        items: [
          { label: 'Classic Cotton Polo T-Shirt', href: '/products?category=Custom Gifts' },
          { label: 'Dry-Fit Sports Polo', href: '/products?category=Custom Gifts' },
          { label: 'Embroidered Corporate Polo', href: '/products?category=Custom Gifts' },
          { label: 'Premium Heavyweight Polo', href: '/products?category=Custom Gifts', isNew: true },
        ],
      },
      {
        heading: 'Women\'s Polo T-Shirts',
        items: [
          { label: 'Fitted Cotton Polo', href: '/products?category=Custom Gifts' },
          { label: 'Dry-Fit Workwear Polo', href: '/products?category=Custom Gifts' },
          { label: 'V-Neck Custom T-Shirt', href: '/products?category=Custom Gifts' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Promotional Jackets & Vests', href: '/products?category=Custom Gifts' },
